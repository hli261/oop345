...
namespace sict
{
	...
	defines a class template for a label-value pair (for example, 
   a product label stored in an std::string object and a quantity
   stored in an int object)
	The template parameters identify the types of the label and value objects
   that constitute an LVPair object:
